=====================================================
PyGPSSurvey : Project to use a GPS system via serial.
=====================================================
...
This project was conducted by the laboratory `UMR5133-Archéorient`_ (FR).
...
PyGPSSurvey is a python project to use a GPS system via serial.
...
**Note:** PyGPSSurvey uses the `PyLink <http://pypi.python.org/pypi/PyLink>`_ lib, offers a universal communication interface with File-Like API.
...
::
  ...
  >>> from pygpssurvey import GpsSurvey
  >>> device = GpsSurvey.from_url('tcp:host-ip:port')
  >>> # or with Serial connection
  >>> device = GpsSurvey.from_url('serial:/dev/ttyUSB0:38400:8N1')
